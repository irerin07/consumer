...
public class BookingDltListener {
	...
	public void onBookingCreatedDlt(@Payload Object payload,
		@Header(KafkaHeaders.RECEIVED_TOPIC) String topic,
		@Header(KafkaHeaders.RECEIVED_PARTITION) int partition,
		@Header(KafkaHeaders.OFFSET) long offset,
		@Header(name = KafkaHeaders.RECEIVED_KEY, required = false) String key) {
		log.error("DLT message received. topic={}, partition={}, offset={}, key={}, payload={}",
			topic, partition, offset, key, String.valueOf(payload));
	}

	@KafkaListener(topics = "booking.cancelled.dlt")
	public void onBookingCancelledDlt(@Payload Object payload,
		@Header(KafkaHeaders.RECEIVED_TOPIC) String topic,
		@Header(KafkaHeaders.RECEIVED_PARTITION) int partition,
		@Header(KafkaHeaders.OFFSET) long offset,
		@Header(name = KafkaHeaders.RECEIVED_KEY, required = false) String key) {
